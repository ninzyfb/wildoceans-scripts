...
png(paste0("Outputs/seasonal_observations/Montly-obs_",target,".png"),width = 20, height = 10, units = "cm", res = 300)
...
if(length(table)>0){
  png(paste0("Outputs/seasonal_observations/Seasonal-obs_",target,".png"),width = 20, height = 10, units = "cm", res = 300)
  par(lwd = 0.5)
