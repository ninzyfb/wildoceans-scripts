...
winter <- BIOMOD_Modeling(
  biomod_obj_seasons[[4]], # your biomod object
...
en_winter <- BIOMOD_EnsembleModeling(
  modeling.output = winter, # your models object
...
library(rasterVis)
library(viridis)
en_preds = get_predictions(en_winter)
type = "winter"
